<template>
  ...
  >
    ...
    <template v-else-if="name === 'lightbulb'">
      <path d="M9 21h6" />
      <path d="M12 3a6 6 0 0 0-4 10.472V17a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3.528A6 6 0 0 0 12 3z" />
    </template>
    ...
    <template v-else-if="name === 'more-horizontal'">
      <circle cx="12" cy="12" r="1" :fill="stroke ? 'currentColor' : 'none'" />
      <circle cx="19" cy="12" r="1" :fill="stroke ? 'currentColor' : 'none'" />
      <circle cx="5" cy="12" r="1" :fill="stroke ? 'currentColor' : 'none'" />
    </template>

    <!-- More Vertical -->
    <template v-else-if="name === 'more-vertical'">
      <circle cx="12" cy="12" r="1" :fill="stroke ? 'currentColor' : 'none'" />
      <circle cx="12" cy="5" r="1" :fill="stroke ? 'currentColor' : 'none'" />
      <circle cx="12" cy="19" r="1" :fill="stroke ? 'currentColor' : 'none'" />
    </template>
